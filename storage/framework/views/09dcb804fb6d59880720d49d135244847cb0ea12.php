                            ...
                            <form id="create_item" method="post" action="<?php echo e(URL::to('/updateItems/'.$item->id)); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                                ...
                                <div id="qt_text_show" <?php if($item->item_type != 1): ?> hidden <?php endif; ?>>
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control text_questions" name="item_text" id="" placeholder="Item"><?php if($item->item_type == 1): ?><?php echo e($item->item); ?><?php endif; ?></textarea>
                                        <div class="invalid-feedback">This field is required.</div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\issb_psychometric\resources\views/edit_items.blade.php ENDPATH**/ ?>