        ...
        <div class="row">
            <?php $__currentLoopData = $test_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-3 animated fadeInLeftBig" style="padding:5px">
                    <a class="view-details" href="<?php echo e(URL::to('/items/'.$test->id.'/5')); ?>">
                        <div class="row">
            ...
            <?php if($memory_bank > 0): ?>
                <div class="col-md-3 animated fadeInLeftBig" style="padding:5px">
                <a class="view-details" href="<?php echo e(URL::to('memory-items/5')); ?>">
                    <div class="row">
                        <div class="col-md-12 lightbluebg view">
                            Memory Bank
                        <span class="widget_circle3 pull-right">
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\issbv2\resources\views/item_bank_demo.blade.php ENDPATH**/ ?>