                            ...
                            <form action="<?php echo e(route('examConfig.store')); ?>" method="post" class="needs-validation form-horizontal" >
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="date" class="form-control" name="exam_date" required="" value="<?php echo e(date('Y-m-d')); ?>">
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\issbv2\resources\views/testingOfficer/examConfig/create.blade.php ENDPATH**/ ?>