                ...
                <div class="col-md-12">
                    ...
                    <legend class="text-bold"></legend>
                        <span id="submitBtnArea" class="pull-right">
                            <a href="<?php echo e(route('examDemoQOne', ['examId'=>$examId])); ?>" class="btn btn-primary btn-lg previousBtn" type="button">Previous</a>
                            <a href="<?php echo e(route('examDemoQThree', ['examId'=>$examId])); ?>" class="btn btn-success btn-lg  ml-2" type="submit">Next</a>
                        </span>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\issbv2\resources\views/conductOfficer/examSchedule/examDemoQTwo.blade.php ENDPATH**/ ?>