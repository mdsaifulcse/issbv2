            ...
            <div class="panel panel-info">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo e(URL::to('/upcoming-events-create')); ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span>Add New</a>
                    </div>
                </div>
...
<script>
    ...
    function modEdit(id) {
        ...
        swal({
            ...
            function() {
                window.location.href = '/upcoming-events-edit/' + id;
            });
    }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\issbv2\resources\views/psycologist/upcoming_events/list.blade.php ENDPATH**/ ?>