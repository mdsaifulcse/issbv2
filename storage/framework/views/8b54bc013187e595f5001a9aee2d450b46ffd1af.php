        ...
        <div class="col-md-4 animated fadeInLeftBig">
            ...
            <div class="row">
                <div class="col-md-12 lightbluebg view">
                    <a class="view-details" href="<?php echo e(url('/psy-picture-list')); ?>">View Details</a>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\issb_psychometric\resources\views/welcome.blade.php ENDPATH**/ ?>