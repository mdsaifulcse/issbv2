                        ...
                        <div class="form">
                            <form method="POST" id="create_random_test">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_time" id="total_time" class="form-control" value="<?php echo e($test_config->total_time); ?>" min="1" placeholder="Total Time" onkeydown="if(event.key==='.'){event.preventDefault();}" oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');" required/>
                                </div>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\issbv2\resources\views/edit_random_test.blade.php ENDPATH**/ ?>