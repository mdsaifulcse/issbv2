                        ...
                        <div class="form">
                            <form id="create_data" class="needs-validation" novalidate>
                                ...
                                <div class="form-group">
                                    <label for="category_name"><?php echo e($mnu); ?> Name</label>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\issbv2\resources\views/create_item_category.blade.php ENDPATH**/ ?>