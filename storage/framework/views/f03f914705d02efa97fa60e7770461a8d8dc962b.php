                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label><b style="font-size: 18px" class="item">Demo Question 1?</b></label>
                            ...
                            <legend class="text-bold"></legend>
                                <span id="submitBtnArea" class="pull-right">
                                    ...
                                    <a href="<?php echo e(route('candidate.examDemoQTwo', ['examId'=>$examId])); ?>" class="btn btn-success btn-lg  ml-2" type="submit">Next</a>
                                </span>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('candidates.layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\issbv2\resources\views/candidates/intructionDemoExam/examDemoQOne.blade.php ENDPATH**/ ?>