                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left"> <i class="livicon" data-name="users" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                            Question Set List <?php if(isset($test)): ?> <b>for <?php echo e($test->name); ?></b> <?php endif; ?>
                        </h3>
                        <div class="pull-right">
                            <?php if(isset($test)): ?>
                            <a href="<?php echo e(URL::to('/question-set')); ?>" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-list" ></span> All Set List</a>
                            <?php endif; ?>
                        ...
                        <table id="example" class="display nowrap" style="width:100%">
                            ...
                            <?php $__currentLoopData = $questions_set; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($value->itemFor?$value->itemFor->name:'N/A'); ?></td>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\issbv2\resources\views/question_set_list.blade.php ENDPATH**/ ?>