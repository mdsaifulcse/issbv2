            ...
            <?php if(!empty($test_list)): ?>
                <?php $__currentLoopData = $test_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-3 animated fadeInLeftBig" style="padding:5px">
                        <a class="view-details" href="<?php echo e(URL::to('/test-configuration-list/'.$test->id)); ?>">
                            <div class="row">
                                <div class="col-md-12 palebluecolorbg view">
                                    <?php echo e($test->name); ?> Test Config
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\issb_psychometric\resources\views/test_config_navigation.blade.php ENDPATH**/ ?>