...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Psy Pictures</li>
    </ol>
</section>
            ...
            <div class="panel panel-info">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="<?php echo e(URL::to('/create-psy-picture')); ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span>Add New</a>
                    </div>
                </div>
                    ...
                    <table id="example" class="display nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo e(asset('assets/uploads/psy_images')); ?>/<?php echo e($value->picture); ?>" width="100"></td>
                                ...
                                <td class="text-center">
                                    ...
                                    <a><i class="livicon" data-name="trash" data-size="20" data-loop="true" data-c="#EF6F61" data-hc="#EF6F61" title="Delete data" onclick=psyPictureDelete('<?php echo $value->id ?>');></i></a>
                                </td>
                            </tr>
...
<script>
    ...
    //         },
    //         function() {
    //             window.location.href = '/edit-psy-picture/' + id;
    //         });
    // }

    function psyPictureDelete(id) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\issb_psychometric\resources\views/psy_images_list.blade.php ENDPATH**/ ?>