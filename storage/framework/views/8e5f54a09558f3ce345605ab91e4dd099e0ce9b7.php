                        ...
                        <div class="form">
                            <form method="POST" id="create_data" class="needs-validation" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="category_name" value="<?php echo e($category->name); ?>" id="category_name" placeholder="Category Name" required/>
                                </div>
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\issbv2\resources\views/update_item_category.blade.php ENDPATH**/ ?>