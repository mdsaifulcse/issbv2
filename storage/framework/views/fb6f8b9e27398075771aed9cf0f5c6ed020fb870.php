        ...
        <div class="row">
            <?php $__currentLoopData = $test_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-3 animated fadeInLeftBig">
                    <a class="view-details" href="<?php echo e(URL::to('/items/'.$test->id.'/3')); ?>">
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\issbv2\resources\views/item_bank_test.blade.php ENDPATH**/ ?>