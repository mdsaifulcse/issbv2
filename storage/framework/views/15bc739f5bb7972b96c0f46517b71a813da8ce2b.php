                        ...
                        <form id="create_numeric_question_set">
                          ...
                          <div class="row" style="margin-bottom: 25px;">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" id="item_numbers" name="total_item" value="<?php echo e($item_set->total_items); ?>" placeholder="Total Item" value="<?php echo e($item_set->total_item); ?>" min="1" onkeydown="if(event.key==='.'){event.preventDefault();}"  oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');" class="form-control numeric_question" required>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                  <label for="set_type">Set Type</label>
                                    <select name="set_type" id="set_type" class="form-control numeric_question" required>
                                        ...
                                        <option value="Active" <?php if($item_set->set_type == 'active'): ?> selected <?php endif; ?>>Active</option>
                                        <option value="Practice" <?php if($item_set->set_type == 'practice'): ?> selected <?php endif; ?>>Practice</option>
                                    </select>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="checkbox-container">
                                                <input type="checkbox" class="check" value="<?php echo e($value->id); ?>||<?php echo e($value->level); ?>" id="check_<?php echo e($value->id); ?>" name="checkbox[]"  <?php $__currentLoopData = $questions_id; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question_id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php if($question_id == $value->id): ?> checked <?php endif; ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>/>
                                            </div>
                                        </td>
                                        <td><?php echo e($value->name); ?></td>
                                        <td>
                                            <?php if($value->item_type == 1): ?>
                                                <?php echo e($value->item); ?>
            ...
            $("#create_numeric_question_set").validate(
                    {
                        ...
                        submitHandler: function(form) {
                            ...
                            if(clicked) {
                                ...
                                var db_value = '<?php echo e($item_set->questions_id); ?>';
                            ...
                            if(x){
                                ...
                                if(data.length == item_numbers ){
                                    ...
                                    $.ajax({
                                        url:"<?php echo e(url('/')); ?>"+"/updateItemSet/" + id,
                                        method:"POST",
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\issb_psychometric\resources\views/edit_static_item_set.blade.php ENDPATH**/ ?>