                                ...
                                <?php if($config->status == 1 && $config->preview_status == 1): ?>
                                    <tr <?php if($config->exam_status == 1): ?> class="bg" <?php endif; ?>>
                                        ...
                                        <?php if($config->preview_status == 1 && $config->exam_status!=0): ?>
                                            <a href="<?php echo e(route('examInstruction', ['examId'=>$config->id])); ?>" class="btn btn-sm btn-primary" target="_blank">Show Introduction</a>
                                        <?php endif; ?>

                                        <?php if($config->preview_status == 1 && $config->exam_status==0): ?>

                                            <a href="<?php echo e(route('examInstruction', ['examId'=>$config->id,'prestart'=>1])); ?>" class="btn btn-sm btn-primary">Show Introduction</a>
                                        ...
                                        <?php elseif($config->preview_status == 1 && $config->exam_status==4): ?>
                                            ...
                                            <a href="<?php echo e(url('examDemoFinish'."?examId=$config->id"."&exam_instruction=0")); ?>" class="btn btn-sm btn-success">Prestart</a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(url('examScheduleList')); ?>" class="btn btn-sm btn-warning" title="Wait for all candidate login">Wait & Refresh </a>
                                                <?php endif; ?>
