        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel-body" style="margin-bottom: 10px;padding: 5px">
                    ...
                    <h2 class="text-center" style="font-size: 25px;margin: 0px;"><?php echo e($exam_name); ?></h2>
                ...
                <iframe width="100%" height="800px" src="<?php echo e(url('ifream-stdSeatPlan')); ?>"></iframe>
            </div>
        </div>
