                    ...
                    <div class="panel-body">
                        <div class="load_content">
                            ...
                            <div class="inst_content">
                                <p class="instruction-text"><?php echo e($configInstruction->text); ?></p>
                                <hr>
                   ...
                   return console.log(response)
                    if (parseInt(response) === 0) {
                        ...
                        `<div class="inst_content">
                            ...
                            <img src="<?php echo e(asset('uploads/instruction/${response.image}')); ?>" alt="" class="instruction-image img-fluid img-thumbnail">
