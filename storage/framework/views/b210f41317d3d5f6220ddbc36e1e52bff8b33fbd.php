                    ...
                    <div class="panel-body">
                        ...
                        <div class="action-btn">
                            <?php if($instructionEndStatus == 0): ?>
                                ...
                                <a class="btn btn-lg btn-primary pull-right" href="<?php echo e(route('candidate.examDemoItemPreview', ['examId'=>$examId])); ?>" role="button">Next</a>
                            <?php else: ?>
                                
                                
                                <a href="<?php echo e(route('candidate.examInstruction', ['examId'=>$examId])); ?>" class="btn btn-lg btn-primary pull-right">Next</a>
                            <?php endif; ?>
                        </div>
