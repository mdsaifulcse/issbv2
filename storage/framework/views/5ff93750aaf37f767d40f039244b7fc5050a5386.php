...
<section class="content">
    <div class="row text-center">
        <h3 style="margin: 0px;"><span>Initial Login Status</span>   <span class="live-div-right"><?php echo e(@$total_live); ?>/<?php echo e($total_candidate); ?> [ Till logged in <?php echo e(@$total_live); ?> out of <?php echo e($total_candidate); ?> ]</span></h3>
    </div>
    <div class="row">
        <div class="col-md-4">
            <div class="plane">
...
<?php echo $__env->make('admin/layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\issbv2\resources\views/conductOfficer/seatPlan/ifream-seatplan.blade.php ENDPATH**/ ?>