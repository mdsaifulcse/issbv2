                            ...
                            <?php $__currentLoopData = $examConfigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr <?php if($data->exam_status == 1): ?> class="color-full1" <?php endif; ?>>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?php echo e(route('examConfig.edit', [$data->id])); ?>"><i class="livicon" data-name="edit" data-size="20" data-loop="true" data-c="#F89A14" data-hc="#F89A14"></i></a>
                                        <a><i class="livicon" data-name="trash" data-size="20" data-loop="true" data-c="#EF6F61" data-hc="#EF6F61" title="Delete data" onclick=Delete(<?php echo e($data->id); ?>);></i></a>
                                        <a href="#"><i data="<?php echo e($config->id); ?>" class="livicon ass_conf_status_update" data-name="info" data-size="20" data-loop="true" data-c="#F89A14" data-hc="#F89A14"></i></a>
                                    </td>
                                </tr>
                                <?php endif; ?>
