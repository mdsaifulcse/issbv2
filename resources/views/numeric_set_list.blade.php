...
@section('content')
    <section class="content-header">
        <!--section starts-->
        <h1>Numeric Item Set List</h1>
        <ol class="breadcrumb">
            <li>
                <a href="#">Admin</a>
            </li>
            <li class="active">Numeric Question List</li>
        </ol>
    </section>
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        ...
                        <div class="pull-right">
                            <a href="{{ URL::to('/create-numeric-item-set') }}" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus" ></span>Create new set</a>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <table id="example" class="display nowrap" style="width:100%">
                            ...
                            <tbody>
                            @foreach($numeric_set as $key => $value)
                                <tr>
                                    <td>{{ ++$key }}</td>
                                    <td>{{ $value->item_set_name }}</td>
                                    <td>{{ $value->total_time }} min</td>
                                    <td>
                                        <a href="{{ URL::to('/update-numeric-item-set/'.$value->id) }}"><i class="livicon" data-name="edit" data-size="20" data-loop="true" data-c="#F89A14" data-hc="#F89A14" title="Update data" ></i></a>
    ...
    <script>
        ...
        function QuestionDelete(id)
        {
            ...
            swal({
                    ...
                    function () {
                        $.ajax({
                            url: '/destroyNumericQuestionSet/' + id,
                            method: 'DELETE',
                            headers:
                            {
                            ...
                            success: function (data) {
                                setTimeout(function () {
                                    swal({
                                                title: "Deleted!",
                                                text: "Numeric Item set has been deleted.",
                                                type: "success",
