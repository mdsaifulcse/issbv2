...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update New Item Tag6</li>
        </ol>
    </section>
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form method="POST" id="create_data" class="needs-validation" novalidate>
                                <input type="hidden" id="id" value="{{ $tag6->id }}">
                                <div class="form-group">
                                    <label for="category_name">Tag Name</label>
                                    <input type="text" class="form-control" name="name" value="{{ $tag6->name }}" id="name" placeholder="Name" required/>
                                </div>
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response == 'success')
                                {
                                    ...
                                    window.location.href = '/item-tag6';
                                }
                            },
                            error: function (e) {
