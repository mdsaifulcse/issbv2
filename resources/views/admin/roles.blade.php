                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group" id="checkbox">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="checkbox">
                                            <label for="terms">
                                                <input id="checkbox{{$permission->id}}" type="checkbox" value="{{$permission->id}}" name="permissions[]" required> {{$permission->name}}
                                            </label>
                                        </div>
                                ...
                                <div class="form-group" id="edit_checkbox">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="checkbox role_edit_checkbox">
                                            <label for="terms">
                                                <input id="checkbox{{$permission->id}}" type="checkbox" value="{{$permission->id}}" name="edit_permissions[]" required> {{$permission->name}}
                                            </label>
                                        </div>
...
<script src="{{ asset('validations/jquery.validate.min.js') }}"></script>
<script src="{{ asset('validations/edit_role_validation.js') }}"></script>
<script src="{{ asset('validations/new_role_validation.js') }}"></script>
