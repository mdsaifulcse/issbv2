...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Create TAT/BL</li>
        </ol>
    </section>
            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form enctype="multipart/form-data" action="{{ url('storePsyPicture') }}" method="POST" novalidate>
                                {{ csrf_field() }}
                                ...
                                <label for="down_text">Picture</label>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="picture_details" id="picture_details" placeholder="Picture Details"/>
                                </div>
