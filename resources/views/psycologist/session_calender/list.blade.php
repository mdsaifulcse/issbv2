...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Session Calender</li>
    </ol>
</section>
            ...
            <div class="panel panel-info">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ URL::to('/session-calender-create') }}" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span>Add New</a>
                    </div>
                </div>
...
<script>
    ...
    function modEdit(id) {
        ...
        swal({
            ...
            function() {
                window.location.href = '/session-calender-edit/' + id;
            });
    }
    ...
    function modDelete(id) {
        ...
        swal({
            ...
            function() {
                $.ajax({
                    url: '/session-calender-delete/' + id,
                    method: 'DELETE',
                    headers: {
