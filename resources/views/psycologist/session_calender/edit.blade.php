...
<section class="content-header">
    <!--section starts-->
    <h5>Session Calender</h5>
    <ol class="breadcrumb">
        <li>
            <a href="{{ URL::to('/') }}">Admin</a>
        </li>
        <li class="active">Edit Session Calender</li>
    </ol>
</section>
        ...
        <div class="col-lg-12">
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    <div class="form">
                        <form enctype="multipart/form-data" action="{{ url('session-calender-update') }}" method="POST" novalidate>
                            {{ csrf_field() }}
