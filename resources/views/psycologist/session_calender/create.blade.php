...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Create Session Calender</li>
        </ol>
    </section>
            ...
            <div class="col-lg-12">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form enctype="multipart/form-data" action="{{ url('session-calender-store') }}" method="POST" novalidate>
                                {{ csrf_field() }}
