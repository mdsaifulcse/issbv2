            ...
            <div class="panel panel-info">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ URL::to('/course-schedule-create') }}" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span>Add New</a>
                    </div>
                </div>
...
<script>
    ...
    function modEdit(id) {
        ...
        swal({
            ...
            function() {
                window.location.href = '/course-schedule-edit/' + id;
            });
    }
