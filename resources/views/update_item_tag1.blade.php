...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update New Item Tag1</li>
        </ol>
    </section>
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form method="POST" id="create_data" class="needs-validation" novalidate>
                                <input type="hidden" id="id" value="{{ $tag1->id }}">
                                <div class="form-group">
                                    <label for="category_name">Tag Name</label>
                                    <input type="text" class="form-control" name="name" value="{{ $tag1->name }}" id="name" placeholder="Name" required/>
                                </div>
