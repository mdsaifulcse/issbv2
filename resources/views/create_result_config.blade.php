            ...
            <div class="col-lg-9 col-lg-offset-">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form">
                            <form method="post" action="{{ route('result-config') }}" id="create_set">
                                {{ csrf_field() }}
...
@section('footer_scripts')
    ...
    $('#test_for').on('change',function(){
        ...
        var testId=$(this).val()
        $('#testConfigDetails').html('<center><img src=" {{asset('images/default/loading.gif')}}"/></center>').load('{{URL::to("load_test_config_data")}}/'+testId); 
    })
    </script>
