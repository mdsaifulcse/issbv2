            ...
            <div class="panel panel-info">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ URL::to('/create-item-tag5') }}" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span>Add New</a>
                    </div>
                </div>
...
<script>
    ...
    function QuestionEdit(id) {
        ...
        swal({
            ...
            function() {
                window.location.href = '/update-item-tag5/' + id;
            });
    }
