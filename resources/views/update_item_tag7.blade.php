...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update New Item Tag7</li>
        </ol>
    </section>
                    ...
                    <div class="panel-body">
                        <div class="form">
                            <form method="POST" id="create_data" class="needs-validation" novalidate>
                                <input type="hidden" id="id" value="{{ $tag7->id }}">
                                <div class="form-group">
                                    <label for="category_name">Tag Name</label>
                                    <input type="text" class="form-control" name="name" value="{{ $tag7->name }}" id="name" placeholder="Name" required/>
                                </div>
