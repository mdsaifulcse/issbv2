        ...
        <div class="row">
            @foreach($test_list as $test)
                <div class="col-md-3 animated fadeInLeftBig" style="padding:5px">
                    <a class="view-details" href="{{ URL::to('/items/'.$test->id.'/2') }}">
                        <div class="row">
            ...
            <div class="col-md-3 animated fadeInLeftBig">
                <a class="view-details" href="{{ URL::to('/vit-question-bank/2') }}">
            ...
            <div class="col-md-3 animated fadeInLeftBig">
                <a class="view-details" href="{{ URL::to('/numeric-question-bank/2') }}">
                    <!-- Trans label pie charts strats here-->
            ...
            <div class="col-md-3 animated fadeInLeftBig">
                <a class="view-details" href="{{ URL::to('/verbal-item-bank/2') }}">
                    <!-- Trans label pie charts strats here-->
                    <div class="panel palebluecolorbg">
                        <div class="panel-body">
                            <div class="row">
