...
@section('content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Create Numeric Item Set</li>
        </ol>
    </section>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row" style="margin-bottom: 25px;">
                            ...
                            <div class="col-md-3">
                                <input type="text" id="item_set_name" placeholder="Item Set Name" name="item_set_name" class="form-control numeric_question" required>
                            </div>
                            <div class="col-md-3">
                                <input type="number" id="item_numbers" name="item_numbers" placeholder="Total Item" min="1" onkeydown="if(event.key==='.'){event.preventDefault();}"  oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');" class="form-control numeric_question" required>
                            </div>
                            <div class="col-md-3">
