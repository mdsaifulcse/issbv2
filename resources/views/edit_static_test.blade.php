                          ...
                          <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="item_set_name" id="item_set_name" value="{{ $test_config->test_name }}" class="form-control" placeholder="Test Name" required/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                               ...
                               <input type="number" id="total_time" name="total_time" placeholder="Total Time" min="1" value="{{ $test_config->total_time }}" onkeydown="if(event.key==='.'){event.preventDefault();}"  oninput="event.target.value = event.target.value.replace(/[^0-9]*/g,'');" class="form-control numeric_question" required>
                            </div>
                              <div class="col-md-3">
                                  <div class="form-group">
                                      <label for="total_time">Pass Mark</label>
                                      <input type="number" name="pass_mark" id="pass_mark" class="form-control numeric_question" value="{{ $test_config->pass_mark }}" min="1" placeholder="Candidate's pass mark" required/>
                                  </div>
                              </div>
                          </div>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="checkbox-container">
                                                <input type="checkbox" class="check" value="{{ $value->id }}" id="check_{{$value->id}}"  name="checkbox[]" @if($test_config->set_id == $value->id && $test_config->flag == 2) checked @endif/>
                                            </div>
                                        </td>
