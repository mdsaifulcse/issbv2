...
<section class="content">
    <div class="row text-center">
        <h3 style="margin: 0px;"><span>Initial Login Status</span>   <span class="live-div-right">{{@$total_live}}/{{ $total_candidate }} [ Till logged in {{@$total_live}} out of {{ $total_candidate }} ]</span></h3>
    </div>
    <div class="row">
        <div class="col-md-4">
            <div class="plane">
