                                ...
                                <label>
                                    <b style="font-size: 18px">
                                        ...
                                        @elseif($question->item_type == 2)
                                            <img src="{{ asset('assets/uploads/questions/images/'.$question->question_title) }}" alt="questionImage">
                                        @else
                                            @php
                                    ...
                                    <label class="@if($question->true_answer == $ansKey){{'text-success'}}@else{{'text-danger'}}@endif" for="ans-{{$ansKey}}">
                                        ...
                                        <span class="text-danger">
                                            ...
                                            @elseif ($question->option_type == 2)
                                                <img src="{{ asset('assets/uploads/options/images/'.$answer) }}" alt="questionImage">
                                            @else
                                                @php
                                    ...
                                    <label>
                                        <b style="font-size: 18px">
                                            ...
                                            @elseif($question->sub_question_type == 2)
                                                <img src="{{ asset('assets/uploads/sub_questions/images/'.$sub_q) }}" alt="questionImage">
                                            @else
                                                @php
