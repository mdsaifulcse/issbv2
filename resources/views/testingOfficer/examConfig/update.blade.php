...
@section('content')
    <section class="content-header">
        <!--section starts-->
        <h5>{{$test?$test->name:''}} :Assessment Configuration</h5>
        <ol class="breadcrumb">
            <li>
                <a href="#">Admin</a>
            </li>
            <li class="active">{{$test?$test->name:''}} :Create Assessment Configuration</li>
        </ol>
    </section>
                ...
                <div class="panel panel-info">
                    <div class="panel-heading clearfix">
                        <h3 class="panel-title pull-left"><i class="livicon" data-name="doc-portrait" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                            {{$test?$test->name:''}} : Create Assessment Configuration
                        </h3>
                    </div>
                    <div class="panel-body">
                        <div class="form">
                            <form action="{{route('examConfig.update', [$examConfig->id])}}" method="post" class="needs-validation form-horizontal" novalidate>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label class="control-label col-lg-3" for="test_config_id">Select Preview Status</label>
                                        <div class="col-lg-6">
                                            <select name="preview_status" id="preview_status" class="form-control" required>
                                                <option value=0 @if($examConfig->preview_status==0) selected @endif>In-Active</option>
                                                <option value=1 @if($examConfig->preview_status==1) selected @endif>Active</option>
                                ...
                                <div class="row text-right">
                                    <div class="col-md-9 offset-md-3">
                                        ...
                                        <a href="{{route('examConfig.index')."?test_for=$test->id"}}" class="btn btn-default">Back To List <i class="icon-backward2 position-right"></i></a>
                                    </div>
                                </div>
                            </form>
                        </div>
