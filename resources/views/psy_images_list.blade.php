            ...
            <div class="panel panel-info">
                <div class="panel-heading clearfix">
                    ...
                    <div class="pull-right">
                        <a href="{{ URL::to('/create-psy-picture') }}" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span>Add New</a>
                    </div>
                </div>
                    ...
                    <table id="example" class="display nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>{{ $value->title }}</td>
                                <td><img src="{{asset('assets/uploads/psy_images')}}/{{$value->picture }}" width="100"></td>
                                <td>{{ $value->order }}</td>
